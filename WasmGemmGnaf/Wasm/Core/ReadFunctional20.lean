...
theorem Step_readA.target_functional_group20
    {state : State} {rule : ReadRule} {source left right : List AdminInstr}
    (hgroup : rule.functionalGroup = 20)
  ...
  all_goals simp_all [constI32_eq_iff, constAddr_eq_iff, Val.toAdmin_eq_iff]
  case arrayInitDataNum.arrayInitDataNum.arrayInitDataNum =>
    constructor
    · apply cunpackConst_output_injective_of_field_eq <;> assumption
    · constructor <;> apply Subtype.ext <;> omega
  all_goals try omega
