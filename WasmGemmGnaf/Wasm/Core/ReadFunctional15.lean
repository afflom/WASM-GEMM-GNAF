...
theorem Step_readA.target_functional_group15
    {state : State} {rule : ReadRule} {source left right : List AdminInstr}
    (hgroup : rule.functionalGroup = 15)
  ...
  all_goals simp_all [constI32_eq_iff, constAddr_eq_iff, Val.toAdmin_eq_iff]
  case arrayNewDataNum.arrayNewDataNum.arrayNewDataNum =>
    subst_vars
    apply arrayNewData_output_injective
