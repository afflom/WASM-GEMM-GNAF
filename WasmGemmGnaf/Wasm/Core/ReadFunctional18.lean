...
theorem Step_readA.target_functional_group18
    {state : State} {rule : ReadRule} {source left right : List AdminInstr}
    (hgroup : rule.functionalGroup = 18)
  ...
  all_goals simp_all [constI32_eq_iff, constAddr_eq_iff, Val.toAdmin_eq_iff]
  case arrayCopyLe.arrayCopyLe.arrayCopyLe =>
    constructor <;> apply Subtype.ext <;> omega
  case arrayCopyGt.arrayCopyGt.arrayCopyGt =>
    constructor <;> apply Subtype.ext <;> omega
  all_goals try omega
